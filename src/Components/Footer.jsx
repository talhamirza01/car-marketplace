...
const Footer = () => {
  ...
  <div className="mx-auto  max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    "Wheelzar — Your trusted destination to buy, sell, and explore the best car deals. Drive smarter, drive with confidence."
    </p>
    ...
    <span>© 2025 Wheelzar. All rights reserved.</span>
  </div>
